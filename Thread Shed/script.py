...
for p in daily_transactions_split:
    o = []
    for l in p:
        o.append(l.replace('\n', '').strip(' '))
    transactions_clean.append(o)
...
for i in thread_sold:
    if not '&' in i:
        ...
        thread_sold_split.extend(i.split('&'))

def color_count(color):
    return int(thread_sold_split.count(color))

colors = ['red', 'yellow', 'green', 'white', 'black', 'blue', 'purple']
for x in colors:
    print(x, 'threads of each color were sold {}'.format(color_count(x)))
